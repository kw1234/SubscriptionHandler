...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/dashboard/metrics", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error fetching metrics: " + error.message });
    }
  });
  ...
  app.get("/api/subscriptions", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error fetching subscriptions: " + error.message });
    }
  });
  ...
  app.get("/api/activity-logs", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error fetching activity logs: " + error.message });
    }
  });
  ...
  app.get("/api/payment-history", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error fetching payment history: " + error.message });
    }
  });
  ...
  app.post("/api/subscriptions/:id/cancel", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error cancelling subscription: " + error.message });
    }
  });
  ...
  app.post("/api/subscriptions/:id/reactivate", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error reactivating subscription: " + error.message });
    }
  });
